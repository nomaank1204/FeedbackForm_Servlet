...
public class FeedbackForm extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (name == null && email == null && feedback == null) {
            ...
            out.print("Rating: ");
            out.print("<select name='rating'>");
            out.print("<option>Excellent</option>");
            out.print("<option>Good</option>");
            out.print("<option>Average</option>");
            out.print("<option>Poor</option>");
            out.print("</select><br/><br/>");

            out.print("Feedback:<br/>");
            out.print("<textarea name='feedback' rows='5' cols='30' required></textarea><br/><br/>");
        ...
        // After submission: show feedback
            ...
            out.print("<h2 style='color:green;'>Thank You for Your Feedback!</h2>");
            out.print("<p><b>Name:</b> " + name + "</p>");
            out.print("<p><b>Email:</b> " + email + "</p>");
            out.print("<p><b>Rating:</b> " + rating + "</p>");
            out.print("<p><b>Feedback:</b> " + feedback + "</p>");
